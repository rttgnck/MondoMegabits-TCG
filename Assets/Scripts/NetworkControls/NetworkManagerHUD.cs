...
namespace Mirror
{
    ...
    public class NetworkManagerHUD : MonoBehaviour
    {
        ...
        public string username = "MondoMan";
        ...
        void OnGUI()
        {
            GUILayout.BeginArea(new Rect(10 + offsetX, 10 + offsetY, 215, 9999));
        ...
        void StartButtons()
        {
            if (!NetworkClient.active)
            {
                ...
                {
                    if (GUILayout.Button("Host only")) manager.StartServer();
                }

                GUILayout.BeginHorizontal();
                GUILayout.Label($"Please use discord for chat.");
                GUILayout.EndHorizontal();
            }
            else
            {
